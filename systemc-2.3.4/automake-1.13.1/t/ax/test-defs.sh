...
am_rel_srcdir='.'
am_top_srcdir='/home/ishna/FYP/ibex/systemc-2.3.4/automake-1.13.1'
am_top_builddir='/home/ishna/FYP/ibex/systemc-2.3.4/automake-1.13.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/usr/local/share/automake-1.13/am'
    am_automake_acdir='/usr/local/share/aclocal-1.13'
    am_bindir='/usr/local/bin'
    am_datadir='/usr/local/share'
    am_docdir='/usr/local/share/doc/automake'
    am_pkgvdatadir='/usr/local/share/automake-1.13'
    am_scriptdir='/usr/local/share/automake-1.13'
    am_system_acdir='/usr/local/share/aclocal'
    ;;
  no)
...
GNU_CXX=${AM_TESTSUITE_GNU_CXX-${GNU_CXX-'c++'}}
